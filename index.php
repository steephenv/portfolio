...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    <nav class="nav-menu">
      <ul>
        ...
        <!-- <li>
          <a href="#portfolio"><i class="bx bx-book-content"></i> <span>Portfolio</span></a>
        </li> -->
        <li>
          <a href="#services"><i class="bx bx-server"></i> <span>Blogs</span></a>
        </li>
        <li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Steephen Varghese</h1>
      <p>
        I'm a
        <span class="typed" data-typed-items="Software Engineer, Developer , Traveller"></span>
      </p>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          ...
          <p class="text-left text-margin">
            ...
            job that fulfills you, that taps into your passions, that brings
            you joy-for the most part, anyway.
          </p>
        </div>

        <div class="row">
          <div class="col-lg-4">
            <img src="assets/img/pi1.jpg" class="img-fluid" alt="" />
          </div>
              ...
              <div class="col-lg-6">
                <ul>
                  <li>
                    ...
                    <strong>Birthday:</strong> 13 Dec 1994
                  </li>
                  <li>
                    <i class="icofont-rounded-right"></i>
                    <strong>Website:</strong> www.steephen.me
                  </li>
                  <li>
                    <i class="icofont-rounded-right"></i>
                    <strong>Phone:</strong> +91 9544529886
                  </li>
                  <li>
                    <i class="icofont-rounded-right"></i>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Elastic Search <i class="val">60%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">AWS <i class="val">65%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">EJS <i class="val">65%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Heroku <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">PM2 <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">ExpressJS <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">PostgresQL <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">HTML and CSS <i class="val">65%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Bash <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Jest <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Mocha <i class="val">60%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Swagger <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Resume</h2>
          <p>
            Experienced in developing NodeJS server side applications in both web and mobile platforms.
          </p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Steephen Varghese</h4>
              <p><em>Innovative and deadline-driven Software developer with 2+ years of experience
                  developing
                  web , andriod and ios applications from initial concept to final product.</em>
              </p>
              <p>
                <ul>
                  <li>Hoysala Nestor,VSNL road, Kakkanad, Kochi</li>
                  <li>+91 9544529886</li>
                  <li>steephenvrs3@gmail.com</li>
                </ul>
              </p>
            </div>
            ...
            <div class="resume-item">
              ...
              <h5>2014 - 2017</h5>
              <p><em>Lakshmi College of Science & Technology, Chalakudy, Thrissur</em></p>
              <p>Completed Bachelor of Computer Application under Kerala University.
              </p>
            </div>
            <div class="resume-item">
              <h4>Pre University</h4>
              <h5>2011 - 2013</h5>
              <p><em>St.Marys Jr.College, Chandrapur, Maharashtra</em></p>
              <p>Completed 12'th in Computer Science group under Nagpur University.
              </p>
            </div>
            <div class="resume-item">
              <h4>10th Standard</h4>
              <h5>2010 - 2011</h5>
              <p><em>St.Sebastians Higher Secondary School, Kuttikad, Thrissur</em></p>
              <p>Completed 10'th from Kerala Board State syllabus
              </p>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <h5>2018 - Present</h5>
              <p><em>Cubet Techno Labs, Carnival infopark, Unit IX-C, 9th floor PhaseIV, Kochi. </em></p>
              <p>
                <ul>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch blog-link" data-aos="zoom-in" data-aos-delay="100"
            onclick="goto('portfolio-details.html')">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a>OAuth 2.0 authentication</a></h4>
              <p>
                A basic overview of OAuth 2.0 authentication
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Hoysala Nestor,VSNL road, Kakkanad, Kochi.</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>steephenvrs3@gmail.com</p>
              </div>
